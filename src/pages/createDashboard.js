...
const CreateDashboard = () => {
	...
	const inputFile = useRef(null);
		const [disableCategory2,setDisableCategory2]=useState(true);
		const [disableCategory3,setDisableCategory3]=useState(true);
						...
						<div className="w-full xl:w-4/5">
							<form>
								...
								<div className="w-full items-start mt-4">
									...
									<input type="text" maxLength="60" placeholder="Title" value={titleNew} onChange={titleChange} className="text-sm w-full px-4 py-2 my-2 md:my-0 border border-gray-300 rounded-md" />
								</div>
								<div className="flex-wrap w-full items-center mt-4">
									...
									<textarea maxLength="2000" placeholder="Description" value={descNew} onChange={descChange} className="text-sm w-full h-32 px-4 py-2 my-2 md:my-0 border border-gray-300 rounded-md" />
								</div>
								<div className="w-full items-center mt-4">
									...
									<div className="w-full md:flex md:space-x-1">
										...
										<div className={"w-full mt-2 md:mt-0 md:flex-1 form-categories border border-gray-300 rounded-md px-2 py-2 "+(disableCategory2 ? 'bg-gray-300': 'bg-white')} role="button">
											<Dropdown isNeedReset={true} title="Select. . ." placeholder="Category 2" items={category1} onClick={changeCategoryid} isDisabled={disableCategory2} idx={1} />
										</div>
										<div className={"w-full mt-2 md:mt-0 md:flex-1 form-categories border border-gray-300 rounded-md px-2 py-2 "+(disableCategory3 ? 'bg-gray-300': 'bg-white')} role="button">
											<Dropdown isNeedReset={true} title="Select. . ." placeholder="Category 3" items={category2} onClick={changeCategoryid} isDisabled={disableCategory3} idx={2} />
										</div>
									</div>
								</div>
